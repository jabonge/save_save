        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(edit.getText().toString().equals("")){
                    ...
                    int target_elec_usage = Integer.parseInt(edit.getText().toString());


                    if (target_elec_usage > 0) {
                        Call<ResponseBody> call = apiInterface.electgoal(target_elec_usage);
